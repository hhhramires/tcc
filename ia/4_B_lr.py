...
modelo = 'Modelo de Regressão Regularizados - Lasso Regression'
...
# Criando e treinando o modelo Lasso Regression
...
plt.title('Previsão de Gastos para 2023 - Lasso Regression')
plt.xlabel('Período')
plt.ylabel('Valor')
plt.legend()
plt.grid(True)
